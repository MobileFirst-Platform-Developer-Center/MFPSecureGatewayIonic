...
public class JavaHTTPResource {
	...
	public void execute(HttpUriRequest req, HttpServletResponse resultResponse)
		...
		String hostName= configurationAPI.getPropertyValue ("host");
		String portvalue= configurationAPI.getPropertyValue ("port");
		String protocol= configurationAPI.getPropertyValue ("protocol");
		client = HttpClientBuilder.create().build();
		host = new HttpHost(hostName, Integer.parseInt(portvalue), protocol);
